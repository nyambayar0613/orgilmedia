...
@section('title', 'Контент засах: '. $content->content_title)
                ...
                <form name="contentAddForm" id="contentAddForm" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control parsley-error" name="content_title" id="content_title" value="{{ $content->content_title }}" required >
                        </div>

                        <div class="form-group">
                            <label>Агуулга</label>
                            <textarea class="ckeditor" name="content_description">{{ $content->content_description }}</textarea>
                        </div>
        ...
        $().ready(function() {
            $('#contentAddForm').submit(function(e) {
                ...
                submitHandler: function(form) {
                    $.LoadingOverlay("show");
                    form.action = "{{ route('admin.content.update') }}"
